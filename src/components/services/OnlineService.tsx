  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-32 bg-slate-900 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-6xl font-black text-center mb-20 text-white uppercase tracking-tight">Quy Trình 4 Bước</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-6xl font-black text-center mb-20 text-slate-900 uppercase tracking-tight">Bảng Giá Tham Khảo</h2>
