      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-16 border-b border-slate-200">
          <div className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all">
            ...
            <div>
              <h4 className="font-bold text-slate-900">Bảo mật tuyệt đối</h4>
          ...
          <div className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all">
            ...
            <div>
              <h4 className="font-bold text-slate-900">Xử lý nhanh chóng</h4>
          ...
          <div className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all">
            ...
            <div>
              <h4 className="font-bold text-slate-900">Bảo hành uy tín</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10">
        <div className="col-span-1 md:col-span-4">
          ...
          <div className="flex gap-4">
            <a href={SITE_CONFIG.social.facebook} target="_blank" aria-label="Facebook" className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all shadow-sm">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href={SITE_CONFIG.social.zalo} target="_blank" aria-label="Zalo" className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-cyan-500 hover:border-cyan-500 hover:text-white transition-all shadow-sm">
              <span className="font-bold text-xs">Zalo</span>
            </a>
            <a href={SITE_CONFIG.social.googleMaps} target="_blank" aria-label="Google Maps" className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-red-500 hover:border-red-500 hover:text-white transition-all shadow-sm">
