      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10">
        <div className="col-span-1 md:col-span-4">
          ...
          <div className="flex gap-4">
            <a href="https://facebook.com" target="_blank" className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all shadow-sm">
        ...
        <div className="col-span-1 md:col-span-4">
          ...
          <ul className="space-y-6 text-base text-slate-600">
            ...
            <li className="flex items-center gap-4 group">
              ...
              <span className="font-black text-slate-900 text-xl tracking-tight">0877.023.032</span>
            </li>
            <li className="flex items-center gap-4 group">
              <div className="w-10 h-10 rounded-xl bg-cyan-50 flex items-center justify-center shrink-0 text-cyan-600 group-hover:bg-cyan-500 group-hover:text-white transition-all">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              </div>
              <span className="font-medium">support@fastfix.com</span>
            </li>
          </ul>
        </div>
      </div>
