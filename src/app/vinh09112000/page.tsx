  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500">Chào mừng trở lại, đây là thống kê tình hình kinh doanh của FastFix.</p>
      </div>
      
      {/* Stats Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
          <div className="w-12 h-12 bg-cyan-100 rounded-2xl flex items-center justify-center text-cyan-600 mb-4">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
          </div>
          <p className="text-sm font-semibold text-slate-500 mb-1">Tổng doanh thu</p>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
          ...
          <p className="text-sm font-semibold text-slate-500 mb-1">Đã hoàn tất</p>
